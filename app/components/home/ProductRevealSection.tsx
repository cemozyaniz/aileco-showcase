...
export default function ProductRevealSection({ scrollRef, heroToProductProgress }: ProductRevealSectionProps) {
  ...
  const text1Opacity = useTransform(scrollYProgress, [0.10, 0.25, 0.80, 0.95], [0, 1, 1, 0]);
  const text1Y = useTransform(scrollYProgress, [0.10, 0.25], [40, 0]);
  const text2Opacity = useTransform(scrollYProgress, [0.15, 0.30, 0.80, 0.95], [0, 1, 1, 0]);
    ...
    <div className="absolute inset-0">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center">
        ...
        <motion.p
          ...
          className="font-body text-lg sm:text-xl font-light text-white/50 leading-relaxed mt-2 text-center px-6 pointer-events-none"
        >
          {t("product.moreThan")}
        </motion.p>
